...
export const assets={
    realmeb,realmef,realmes,dellf,lenovob,lenovoc,lenovof,pocob,pocof,pocos,oppob,oppof,oppos,logo,search,profile,cart,menu,back,tf7,cross,delete1,upload,add,order,list
};
